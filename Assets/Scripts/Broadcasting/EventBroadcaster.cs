...
public class EventBroadcaster
{
    ...
    private EventBroadcaster()
    {
        ...
        //Debug.Log("Event broadcaster init");
    }
    ...
    {
        //Debug.Log("from add observer p: " + action.ToString());
    ...
    {
        //Debug.Log("from add observer: " + action.ToString());
    ...
    public void PostEvent(string notificationName)
    {
        if (this.eventObservers.ContainsKey(notificationName))
        {
            ...
            //Debug.Log("from Post event no params");
        }
    }
    ...
    public void PostEvent(string notificationName, Parameters parameters)
    {
        if (this.eventObservers.ContainsKey(notificationName))
        {
            ...
            //Debug.Log("from Post event WITH params");
